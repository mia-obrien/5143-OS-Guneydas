...
if __name__ == '__main__':
    ...
    print_cmd(cmd)  
    cmdDriver = processCommands.CommandHelper()                      
    ...
    while True:                             # loop forever
        ...
        #if char == '\x03' or cmd == 'exit' or cmd == 'q': # ctrl-c
            #exit()
        
        #elif char == '\x7f':                # back space pressed
        if char == '\x7f':                # back space pressed
            cmd = cmd[:-1]
            print_cmd(cmd)
            ...
            #   params = cmd[1]
            #   print(params)
            driverVariable = cmdDriver.invoke(cmd)
           
            
            # This 'elif' simulates something "happening" after pressing return
            # driverVariable = cmdDriver.invoke(cmd = cmd[0], params = params)
            print(driverVariable)
